...
# Build vfs_ceph module and ctdb ceph mutex helper by default
...
# Build vfs_io_uring module by default
%ifarch aarch64 ppc64le s390x x86_64
...
BuildRequires: libglusterfs-devel >= 3.4.0.16
%endif
...
Requires: %{name}-dcerpcd-libs = %{samba_depver}
